...
namespace UI
{
    namespace MainMenu
    {
        ...
        void MainMenuUIController::bubbleSortButtonCallback()
        {
            ...
            ServiceLocator::getInstance()->getGameplayService()->sortElement(Gameplay::SortType::BUBBLE_SORT);
        }
        ...
        void MainMenuUIController::insertionSortButtonCallback()
        {
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(Gameplay::SortType::INSERTION_SORT);
        }
        ...
        void MainMenuUIController::selectionSortButtonCallback()
        {
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(Gameplay::SortType::SELECTION_SORT);
        }
        ...
        void MainMenuUIController::mergeSortButtonCallback()
        {
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(Gameplay::SortType::MERGE_SORT);
        }
        ...
        void MainMenuUIController::quickSortButtonCallback()
        {
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(Gameplay::SortType::QUICK_SORT);
        }
        ...
        void MainMenuUIController::radixSortButtonCallback()
        {
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(Gameplay::SortType::RADIX_SORT);
        }
